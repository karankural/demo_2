assdiwd:sdFeature: Automation for PAbout Us Page to reduce manual effort of manual testing, here we will going to automate validation of CSS, nested CSS, response status of hrefs and sources of images.
  @blackbox @1
